...
def show_legal_info():
    ...
    with col_l:
        with st.expander("Mentions Légales"):
            st.markdown("<div style='font-size: 11px; color: #444;'>socialexpertfrance.fr - Direction Expert Social Pro.</div>", unsafe_allow_html=True)
    with col_r:
        with st.expander("Politique de Confidentialité"):
            st.markdown("<div style='font-size: 11px; color: #444;'>Traitement volatil en RAM. Pas de stockage.</div>", unsafe_allow_html=True)
