...
# --- 2. GESTION DU FOND D'ÉCRAN (INDISPENSABLE POUR LE VISUEL) ---
...
# --- 3. DÉFINITION DES NOMS PROS (INDISPENSABLE POUR VOTRE CODE) ---
NOMS_PROS = {
...
st.markdown("""
<style>
    /* C'est la ligne magique à ajouter ici : */
...
# --- 6. CHARGEMENT IA & BASE DE DONNÉES ---
...
# --- 9. LOGIQUE DE RÉPONSE (CELLE QUE VOUS VOULEZ) ---
        ...
        with st.expander("📚 Sources réellement utilisées"):
            ...
            if law_results:
                for doc in law_results:
                    ...
                    # FILTRE : Afficher si cité dans le texte OU si c'est la jurisprudence
